...
# Default assumes the local dev workspace layout (this repo nested two levels
# under a sibling data/ dir). Anyone cloning skill-graph-mcp standalone must
# set SKILLS_LIB_PATH to wherever they placed the raw SKILL.md source library.
_DEFAULT_SKILLS_LIB = ROOT.parents[1] / "data" / "sklills_lib" / "skills"
SKILLS_LIB = Path(os.getenv("SKILLS_LIB_PATH", str(_DEFAULT_SKILLS_LIB)))
